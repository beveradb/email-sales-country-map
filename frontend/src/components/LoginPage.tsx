    ...
    <div className="login-page">
      <div className="login-container">
        ...
        <div className="login-header">
          ...
          <p className="tagline">Visualize your global sales data from Gmail on an interactive world map</p>
        </div>

        {/* App Purpose and Functionality */}
        <div className="app-overview">
          <h2>What is Email Sales Map?</h2>
          <p className="overview-description">
            Email Sales Map is a free, open-source data visualization tool that helps content creators 
            and entrepreneurs understand their global customer base by analyzing sales notification emails 
            from platforms like Clips4Sale. The app creates beautiful, interactive world maps showing 
            where your sales are coming from geographically.
          </p>
